...
const projectsData = [
    { title: "Terraform Method of Procedure", description: "Standardized infrastructure deployment using Terraform for consistency and efficiency.", url: "https://www.notion.so/Terraform-Method-of-Procedure-29a6aa96f90b80f89ab4c67e174468dc", icon: FileCode },
    ...
    { title: "AWS Notes", description: "A collection of technical notes, code snippets, and cloud engineering insights.", url: "https://www.notion.so/NOTES-18b6aa96f90b803aa907e8b0c900c1cf", icon: NotebookText }
];
